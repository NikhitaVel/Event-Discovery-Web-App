...
namespace FinalProject.Pages
{
    public class music : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            var eventTask = client.GetAsync("https://api.seatgeek.com/2/events?client_id=Mzc4MDQwMzh8MTY5ODI2NTUzMy4yMDYzODk&venue.state=OH&venue.city=Cincinnati&taxonomies.name=concert");
